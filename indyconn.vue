                ...
                <v-stepper-content step="8">
                  <v-card class="mb-5" height="370px">
                    <v-form ref="form8">
                      ...
                      <v-flex xs12 d-flex>
			<v-text-field sx6 dense v-model="model.contractor_contact2" label="Contractors' Landline Number" valid-color="green" style="margin: 1em; width: 10px" @update="onUpdate2" maxlength="9" :rules="[(v) => !!v || 'Landline Number is required', (v) => v !== model.nok_contact1 || 'Landline Number Must Differ From Next of Kin Cellphone Number', (v) => v !== model.owner_contact1 || 'Landline Number Must Differ From Owner Cellphone Number']"></v-text-field>
