<template>
  <div id="pageDashboard" style="min-width:0px;overflow-x:auto">
    <v-container grid-list-xl fluid>
            ...
            <v-widget title="Payment Status" content-bg="white"
              ...
              <div slot="widget-content">
                <div v-show="paystatus.transStatus == 'PENDING SUBSCRIBER VALIDATION'">
                  ...
                  <h2>Transaction In Progress, if you do not get a prompt on your mobile please dial *151*2*4# to approve
                    transaction. <v-btn text color="primary" @click="startover">Click here to try again.</v-btn></h2>
                </div>
                <div v-show="paystatus.transStatus == 'COMPLETED'">
                  ...
                  <h2 style="color:green">
                    ...
                    <v-btn text color="primary" @click="startover">Click here to make another payment</v-btn>
                  </h2>
                </div>
                    ...
                    <td>
                      <div v-show="isLoading">
                        <p style="line-height: 2.0em;font-family: Consolas">
                          <img src="/logo.png" style="display: block; margin-left: 120px;margin-right: auto;" height="80"
                            width="80" alt="ZETDC Logo" />
                          <br />----------------------------------------
      ...
      <div v-if="details">
        <v-layout row wrap>
          <v-flex lg8 sm12 xs12 id="my">
            <v-widget title="Make Payment" content-bg="white" style="font-family: 'Gill Sans', Arial, Helvetica, sans-serif;">
              <div slot="widget-content">
                <loading :active.sync="isLoading" :can-cancel="false" :width="110" :height="110" backgroundColor="#ffffff"
                  :opacity="0.5" :zIndex="999" :color="API.getLoaderColor" :loader="API.getLoader"
                  ...
                  <v-stepper-items>
                      ...
                      <v-card class="mb-12" height="200px">
                        <v-form ref="form1">
                          <v-col class="d-flex" cols="12" sm="6" md="3">
                            <v-select :items="items" item-text="accountt" required
                              :rules="[v => !!v || 'Account Type is required']" item-value="abbr"
                              @change="accType($event)" v-model="payment.acctype" label="What to Pay?"
                              outlined></v-select>
                          </v-col>
                          <v-col class="d-flex" cols="12" sm="6" md="3">
                            <v-text-field v-model="payment.nisrad" :label="account_label" outlined
                    ...
                    <v-stepper-content step="2">
                        ...
                        <v-item-group>
                          <v-container>
                            <v-row>
                              <v-col md="4">
                                <v-item>
                                  <v-card :class="{ activated: activeEcocash }" value="Ecocash"
                                    @click="selectedPay('activeEcocash')">
                                    <img src="/ecocash-logo.png" height="90" width="90" alt="ZETDC Logo" />
                      ...
                      <v-card class="mb-12" height="420px">
                        <v-form ref="form2">
                          <v-row></v-row>
                          <v-col class="d-flex" cols="12" sm="6" md="3">
                            <v-text-field label="Email Address (Optional)" type="email" v-model="payment.email"
                              outlined></v-text-field>
                          </v-col>
                          <v-col class="d-flex" cols="12" sm="6" md="3">
                            <v-text-field label="Contact Phone" :rules="[
                              v => !!v || 'Contact Phone is required']" v-model="payment.contactphone"
                              outlined></v-text-field>
                          </v-col>
                          <v-col cols="16" md="4">
                            <v-label>Ecocash Number</v-label>
                            <VuePhoneNumberInput v-model="payment.mobile" required style="min-width:300px"
                              @update="onUpdate" default-country-code="ZW" :only-countries="['ZW']" valid-color="green" />
                          </v-col>
                          <v-col class="d-flex" cols="12" sm="6" md="3">
                    ...
                    <v-stepper-content step="3">
                      ...
                      <v-card class="mb-12" height="590px" v-if="payment.acctype == 2">
                        ...
                        <v-simple-table>
                          <tbody>
                            ...
                            <tr>
                              <td>Balance</td>
                              <td>${{ ((personal.security_DEPOSIT + personal.connection_CHARGES +
                                personal.vat).toFixed(2) - paid.toFixed(2)).toFixed(2) }}</td>
                            </tr>
                            <tr>
                              <td>Job Status</td>
                            ...
                            <tr>
                              ...
                              <td>${{ (personal.security_DEPOSIT + personal.connection_CHARGES + personal.vat).toFixed(2) }}
                              </td>
                            </tr>
                            <tr>
                              <td>ZETDC Reference</td>
                      ...
                      <v-btn color="primary"
                        ...
                        @click="pay()">Confirm</v-btn>

                      <v-btn text @click="cancelled">Cancel</v-btn>
                    </v-stepper-content>
                  </v-stepper-items>
                </v-stepper><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </v-widget>
          </v-flex>
        </v-layout>
                    ...
                    .then(respo => {
                      ...
                      if (respo.data != "") {
                        ...
                        if (this.personal.estado != "17004") {
                          this.pJobNotAllowed = true;
                        } else if ((this.payment.amount != (total - this.paid).toFixed(2)) && ((total - this.paid).toFixed(2) < 10000)) {
                          this.overAmount = true;
                          //this.isUSD=true
                          console.log("here 1")
                        }
                      } else if (this.payment.amount != total && total < 10000) {
                        this.overAmount = true;
                        // console.log(total)
                        // this.isUSD=true
                      } else if (this.personal.estado != "17004") {
