                        ...
                        <div class="layout column align-center">
                            <center>
                                <h2 style="font-family: 'Gill Sans', Arial, Helvetica, sans-serif;">
                                    <font color='#3f51b5'>
                                        <b>Staff Tracking Application Page</b>
                                    </font>
                                </h2>
                            </center>
                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <v-card v-show="showed" width="1024" class="layout column align-left"><br>
                        <v-row justify="center">
                            <v-col cols="12" sm="6" md="3">
                                <v-btn outlined block color="red" :href="`http://172.16.29.12:3001/images/${pstatus.postal_proof}`" target="_blank"><span style="font-size: 9px">View Proof Of Residence</span></v-btn>
                            </v-col>
                            <v-col cols="12" sm="6" md="3">
                                <v-btn outlined block color="red" :href="`http://172.16.29.12:3003/images/${pstatus.owner_id_proof}`" target="_blank"><span style="font-size: 9px">View National ID</span></v-btn>
                            </v-col>
                            <v-col cols="12" sm="6" md="3">
                                <v-btn outlined block color="red" :href="`http://172.16.29.12:3005/images/${pstatus.nok_id_proof}`" target="_blank"><span style="font-size: 9px">View Next Of Kin National ID</span></v-btn>
                            </v-col>
                            <v-col cols="12" sm="6" md="3">
                                <v-btn outlined block color="red" :href="`http://172.16.29.12:3006/images/${pstatus.transfer_add_proof}`" target="_blank"><span style="font-size: 9px">View Transfer Proof Of Residence</span></v-btn>
                            </v-col>
                        </v-row><br/><br/>
                            ...
                            <table border="0" width="980">
                                <tr>
                                    <td width="80px" align="center" style="font-size:12px;"
                                        ...
                                        <!--  <v-tooltip :v-model="true" top>
                      <v-btn fab dark small fixed bottom right slot="activator" style="bottom:70px">
