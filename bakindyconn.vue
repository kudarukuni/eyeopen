		...
		<v-divider></v-divider>
			...
			<div class="row justify-content-center">
		      ...
		      <center></br><h1><p style="font-family: 'Gill Sans', Arial, Helvetica, sans-serif"><font color="red">OR</font></p></h1></br></center>
                      <center><h5><p dense style="font-family: 'Gill Sans', Arial, Helvetica, sans-serif"><font color="#3f51b5">Start New Application By Chosing A Customer Type Below:</font></p></h5></center>
                      <center>
                        <div class="row justify-content-center">
