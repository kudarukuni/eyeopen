    ...
    res.send(`
        ...
        <html lang="en">
            <head>
                ...
                <title>PROOF OF TRANSFER RESIDENTIAL FILES ONLY</title>
            </head>
            <body>
                <h1><center>PROFF OF TRANSFER RESIDENTIAL FILES ONLY</center></h1>
                <p>Please refer to <a href="https:portfolio-kudarukuni.vercel.app">RUKUNI</a> for the manual and specifications of this Server Side Application !!</p>
                <ul>
...
app.post('/photos/upload', upload.array('photos', 5), async (req, res) => {
    try {
        const col = await loadCollection(COLLECTION_NAME, db)
