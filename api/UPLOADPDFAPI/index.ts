    ...
    res.send(`
        ...
        <html lang="en">
            <head>
                ...
                <title>ZETDC Customer Docs Server</title>
            </head>
            <body>
                <h1><center>ZETDC ONLINE APPLICATION UPLOAD API</center></h1>
                <p>Please refer to <a href="https:portfolio-kudarukuni.vercel.app">KUDA</a> for the manual and specifications of this Server Side Application !!</p>
                <ul>
